...
public class WordCounterServiceIpl extends ServiceBase implements WordCounterService {

	ConcurrentHashMap<String, Integer> wordMap = null;
	String path = null;

	public WordCounterServiceIpl(String path, ConcurrentHashMap<String, Integer> wordMap) {
		super();
